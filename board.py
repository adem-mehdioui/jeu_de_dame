...
initial_board = [
    [None, checkerPiece("white"), None, checkerPiece("white"), None, checkerPiece("white"), None, checkerPiece("white")],
    [checkerPiece("white"), None, checkerPiece("white"), None, checkerPiece("white"), None, checkerPiece("white"), None],
    [None, checkerPiece("white"), None, checkerPiece("white"), None, checkerPiece("white"), None, checkerPiece("white")],
...
def dessiner_plateau():
    for ligne in range(8):
        for colonne in range(8):
            ...
            if piece:
                piece_color = (255, 0, 0) if piece.color == "red" else (255, 255, 255)
